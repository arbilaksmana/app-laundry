                        ...
                        <tr v-for="(m, index) in member" :key="index">
                          ...
                          <td>
                            ...
                            <button
                              type="button"
                              class="
                                btn btn-danger btn-circle btn-icon
                              "
                              @click="alertDisplay(m.id_member)"
                            >
      ...
      this.$swal({
        ...
        if (result.value) {
          this.$swal(
            ...
            this.axios
              .delete(
                `http://localhost/Laundry-UKK-Final/public/api/delete_member/${id_member}`,
                {
                  headers: {
          ...
          this.$swal("Dibatalkan", "Data Anda masih aman", "info");
        }
      });
    },
    hapus(id_member) {
      this.$swal.fire({
        ...
        .then((res) => {
          ...
          this.member.splice(i, 1);
          this.$swal("Suksess", res.data.message, "success")
          }
          
        })
        .catch(this.$swal("Gagal menghapus data member", "error"))
        }
      })
