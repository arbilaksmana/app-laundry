                ...
                <div class="card-body">
                  <form @submit.prevent="tambah">
                    ...
                    <div class="form-group">
                      ...
                      <input v-model="detail.quantity" type="text" class="form-control" >
                    </div>
...
export default {
  ...
  created() {
    ...
    this.axios.get(
        "http://localhost/Laundry-UKK-Final/public/api/get_paket",
  ...
  methods: {
    tambah() {
      this.axios.post(
          "http://localhost/Laundry-UKK-Final/public/api/transaksi/detail/tambah",
          this.detail,
          {
            headers: { Authorization: `Bearer` + this.$store.state.token },
          }
