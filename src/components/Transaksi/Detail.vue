...
export default {
  ...
  created() {
    ...
    this.axios
      .get(
        `http://localhost/Laundry-UKK-Final/public/api/transaksi/${this.id_transaksi}`,
    ...
    this.axios
      .get(
        `http://localhost/Laundry-UKK-Final/public/api/transaksi/detail/${this.id_transaksi}`,
        { headers: { Authorization: `Bearer ` + this.$store.state.token } }
      )
      .then((res) => {
    ...
    this.axios
      .get(
        `http://localhost/Laundry-UKK-Final/public/api/transaksi/total/${this.id_transaksi}`,
        { headers: { Authorization: `Bearer ` + this.$store.state.token } }
      )
      .then((res) => {
  ...
  methods: {
    ubahStatus() {
      ...
      this.axios
        .post(
          `http://localhost/Laundry-UKK-Final/public/api/transaksi/status/${this.id_transaksi}`,
          this.transaksi,
          {
            headers: { Authorization: `Bearer ` + this.$store.state.token },
          }
    ...
    bayar() {
      this.axios
        .post(
          `http://localhost/Laundry-UKK-Final/public/api/transaksi/bayar/${this.id_transaksi}`,
          this.transaksi,
          {
            headers: { Authorization: `Bearer ` + this.$store.state.token },
          }
